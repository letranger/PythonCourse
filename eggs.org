...
#+begin_export html
<a href="https://hits.sh/letranger.github.io/PythonCourse/eggs.html/"><img align="right" alt="Hits" src="https://hits.sh/letranger.github.io/PythonCourse/eggs.html.svg"/></a>
#+end_export
...
# 註：pandas 3.0 起預設啟用 Copy-on-Write，切片後直接賦值會失效（或引發警告），
# 需先以 .copy() 建立獨立副本再新增欄位
done = scores[['nickname','item','score','timestamp']].copy()
...
# 註：MoviePy 2.x 已移除 moviepy.editor 模組，改為直接從 moviepy 匯入
