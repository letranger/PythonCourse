...
- str.isdecimal(), str.isdigit(), str.isnumeric(): 字串是否為數字[fn:20]
  以涵蓋範圍論，isdecimal() ⊆ isdigit() ⊆ isnumeric()，即，若一字串為 decimal，則一定也是 digit 和 numeric。
- isdigit()
...
- isnumeric()
  ...
  - False: 無
  - Error: byte 數字（單位元組）
- Some examples of characters isdecimal()==True [fn:21]
...
[fn:21] [[https://stackoverflow.com/questions/44891070/whats-the-difference-between-str-isdigit-isnumeric-and-isdecimal-in-python][What's the difference between str.isdigit, isnumeric and isdecimal in python?]]

[fn:20] [[https://www.itread01.com/content/1550041754.html][python判斷字串，str函式isdigit、isdecimal、isnumeric的區別]]
