...
#+END_SRC
- for迴圈的變數會依序走訪序列中的元素
- 序列[fn:1]可為range函式、字串(string)、表列(list)、元組(tuple)、字典(dict)、集合(set)
...
[fn:1][[http://liyangbit.com/tutorials/python-list/][Python數據類型-List介紹]]

[fn:2][[https://www.programiz.com/python-programming/list-vs-tuples][Python List vs. Tuples]]
